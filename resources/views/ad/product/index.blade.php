...
<div class="container-fluid Admin_Size_content">
    ...
    <a href="{{route('product.create')}}" class="btn btn-success" ><i class="fa fa-plus-circle"></i>Thêm</a>
        ...
        <tbody>
            @foreach($products as $product)
                <tr>
                    ...
                    <td >
                        <a href="{{route('product.show', $product->id)}}" title="" class="btn btn-success btn-md"><i class="fa fa-edit "></i> Xem</a>
                    </td>
                    <td>
                        <a href="{{route('product.edit', $product->id)}}" title="" class="btn btn-primary"><i class="fa fa-edit "></i> Sửa</a>
                    </td>
                    <td>
